...
%% Option 3 - directly use partition coefficients from Ramachandran
...
sgtitle('Rifampicin - Mouse Day 1 - Model 3 Ramachandran','FontSize',30);

%% Option 4 - try to calculate the partition coefficients using RR equations with info from Ramachandran
...
sgtitle('Rifampicin - Mouse Day 1 - Model 4 Calculate KP','FontSize',30);
