...
n_pts_INHFA = 1;
n_days_INHFA = 1; % > TODO is steady state
days_to_plot_INHFA = 1;
relevant_compts_INHFA = {"Plasma"};
...
INHFA_AUC_target = 271; % AUC/MIC, from Jayaram et al.
INHFA_Cmax_target = 175; % Cmax/MIC, from Gumbo et al.
...
plotPTAs("INHFA", nontoxic_compts_INHFA, ...
            AUCs_oral_INHFA, AUCs_lung_INHFA, ...
            Cmaxs_oral_INHFA, Cmaxs_lung_INHFA, ...
            MICs_TB_INHFA, ...
            INHFA_AUC_target, INHFA_Cmax_target, ...
            oral_dose_INHFA, oral_dose_freq_INHFA, ...
            lung_dose_INHFA, lung_dose_freq_INHFA, ...
