...
% EMB - step is 0.1 instead of 0.01
A0_EMB= zeros(1,18); A0_EMB(18) = 1200;
[t_EMB, A_EMB] = ode23s(@(t, A) humanEqns(t, A, ka_EMB, kr_EMB,kF, CL_EMB, fR_EMB, phys, pt_EMB), [0:0.1:24], A0_EMB,options);
nexttile
...
%INH - step is 0.1 instead of 0.01
